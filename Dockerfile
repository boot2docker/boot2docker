...
RUN echo "#!/bin/sh" > $ROOTFS/usr/local/bin/autologin && \
	...
	echo 'ttyS0:2345:once:/sbin/getty -l /usr/local/bin/autologin 9600 ttyS0 vt100' >> $ROOTFS/etc/inittab && \
	echo 'ttyS1:2345:once:/sbin/getty -l /usr/local/bin/autologin 9600 ttyS1 vt100' >> $ROOTFS/etc/inittab
